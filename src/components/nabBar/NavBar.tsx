      ...
      <Navbar.Collapse>
        <Nav>
          ...
          <NavDropdown title="Book catagories">
            <NavDropdown.Item href="/books/catagory/action">Action</NavDropdown.Item>
            <NavDropdown.Item href="/books/catagory/Adventure">Adventure</NavDropdown.Item>
            ...
            <NavDropdown.Item href="/books/catagory/crime">Crime</NavDropdown.Item>
            <NavDropdown.Item href="/books/catagory/crime">Mystery</NavDropdown.Item>
