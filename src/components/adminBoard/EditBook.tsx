...
const EditBook = (props: { eId: string; editStatus: () => void }) => {
          ...
          genres: res.data.genres[0]
            ...
            .map(
              (genre: string) =>
                ...
                genre.trim().slice(1).toLowerCase()
            ),
        }
        setBook(newBook)
      })
  ...
  function validationSchema() {
    return Yup.object().shape({
      ...
      authors: Yup.string().required('Author Id is required'),
